...
export default function Navbar(){
    ...
    return(
        <nav className="w-full  ">
            ...
            <div className="md:hidden w-full  bg-red-500">
             ...
             <AnimatePresence>
                    {isOpen && (
                        <motion.div
                            className="fixed inset-0 bg-black/30 z-40 w-3/4"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                ...
                <AnimatePresence>
                    {isOpen && (
                        <motion.div
                            ...
                            className="fixed top-0 left-0 h-full w-full z-50 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 flex flex-col bg-blue-500"
                        >
